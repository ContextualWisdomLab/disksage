...
- Raise the DiskSage application MSRV and exact local, CI, and release compiler baseline from Rust 1.88 to 1.97.1; keep the compiler reproducible through the root toolchain manifest and review later stable updates through Dependabot's `rust-toolchain` ecosystem.

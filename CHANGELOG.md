...
- Source cloud copy approval phrases from the Rust plan response so the frontend displays and verifies the same authorization text enforced by the backend.

...
- Align the pull-request release-artifact verifier with the `windows-2022` build-matrix artifact
  name so exact-set validation can pass for the files the release job actually uploads.

...
- 🗂 **Ontology-based organizing** — files classified into an OWL taxonomy you can edit; move plans bind metadata-first production-time lineage and source size/mtime, revalidate them immediately before moving, and skip File Provider dataless sources

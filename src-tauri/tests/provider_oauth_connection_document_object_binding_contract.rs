...
//! a different object than the object that passed admission. The reader must open the final
//! component without following links, validate metadata from that handle, and bound bytes from the
//! same handle.

...
//!
//! The callback parser is intentionally private. Include the production module so percent decoding,
//! CSRF comparison, duplicate-field rejection, denial handling, and authorization-code bounds are
//! exercised without opening a listener, contacting a provider, touching the credential store, or
//! publishing durable OAuth metadata.

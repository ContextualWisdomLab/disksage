...
- Worktrees and standalone clones require fresh exact Git/GitHub authority, clean and inactive
  state, no active owner-created lease or Git worktree lock, explicit approval, and no branch
  deletion or Git pruning. Lease expiry is supplied by its owner; DiskSage never invents one.

...
| #266 | `26ac27b77de8b649f90561f2aba7fa626b4bf5f6` | blocked, review required, auto-merge enabled | Ancestor inventory scans prune managed iCloud, OneDrive, and Google Drive roots before metadata traversal; explicit provider-root scans remain available | Focused scanner tests pass; hosted checks and independent approval remain required |

...
**Repository heads at snapshot:** PR #259 `a019dda`, PR #258 `ff2e36d`, PR #227 `98fa709`, PR #249 `2f1d585`,
...
| #258 | `ff2e36d02ff50fa49d164165921927389489538b` | `7eb131c4` | no | blocked | required | current baseline/docs head; checks remain authoritative |
...
`8100be1272212d8eef4fc323e816fe195356245f`, with the deleted URL/loopback tests and doctoring
document restored after an eighteenth optimizer regression, explicit zero and out-of-range ports

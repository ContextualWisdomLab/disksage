...
**Repository head at snapshot:** `feat/provider-sync-dynamic-goals` @ `88001d8` (current main dependency line merged into the iCloud evidence/readiness implementation)

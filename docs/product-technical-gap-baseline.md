...
**Repository heads at snapshot:** `feat/provider-sync-dynamic-goals` implementation @ `88001d8`; documentation @ `9f018fc` (latest incident evidence)

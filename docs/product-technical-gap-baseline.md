...
**Repository heads at snapshot:** PR #262 `a48af8c5`, PR #260 `041cce6`, PR #259 `ae5e158`, PR #258 `fe4a4c8`, PR #257 `d09808f`, PR #253 `7db00e2`, PR #251 `7b8caa3`, PR #227 `98fa709`, PR #249 `7c93e17`,
...
| #258 | `fe4a4c8a0d601b25042fe4f1f2f475a5a8de7e48` | `7eb131c4` | no | blocked | required | current baseline/docs head; records PR #251/#253 dependency evidence and the current timeout, privacy-scope, cancellation, and placeholder-adoption gaps; hosted checks and qualifying approval remain authoritative |

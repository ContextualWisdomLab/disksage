...
**Repository heads at snapshot:** `feat/provider-sync-dynamic-goals` implementation @ `cc26d41`; documentation @ `8378a98` (latest incident evidence)

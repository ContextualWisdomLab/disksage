...
| #246 | `7e5910dd8fc1cfda896b7a96bfd0d35ab9b5129e` | blocked, review required, auto-merge enabled | Customer guidance now hides implementation terms in iCloud feedback, copy records, and page metadata; the executable contract rejects forbidden vocabulary and requires next actions | Focused UI suite 20/20, Svelte check 0 errors/0 warnings, and diff check pass; hosted checks and independent approval remain required |
...
| #266 | `b2a59e649e333d69ed4fbc5035eb29010d19bdd0` | blocked, review required, auto-merge enabled | Ancestor inventory scans prune only verified provider roots under the user home; explicit provider-root scans remain available and nested same-named folders are preserved | Focused scanner tests pass; hosted checks and independent approval remain required |

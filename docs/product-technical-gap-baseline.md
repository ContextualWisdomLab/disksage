...
**Repository heads at snapshot:** PR #260 `69f88d2`, PR #259 `86dd521`, PR #258 `856099b`, PR #227 `98fa709`, PR #249 `2f1d585`,
...
| #260 | `69f88d2caaebca934735176f0f1c832b8694555f` | `7eb131c4` | no | blocked | required | current-main successor for closed draft #225; Rust planner rejects cwd-dependent, named-tilde, and parent-traversal ontology targets, preserves literal absolute tildes, and adds ADR-0010 plus a Windows public-boundary contract; hosted checks and independent approval remain authoritative |
| #258 | `856099bf47896e31404d3d1adb4008f2089f63fb` | `7eb131c4` | no | blocked | required | current baseline/docs head immediately before this exact-head reconciliation; hosted checks and qualifying approval remain authoritative |

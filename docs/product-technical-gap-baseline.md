...
**Repository heads at snapshot:** PR #259 `e1a710a`, PR #258 `db64a4f`, PR #227 `98fa709`, PR #249 `2f1d585`,
...
| --- | --- | --- | --- | --- | --- | --- |
| #259 | `e1a710a99eb3ee6e0da5478b2b681f1eb5e77717` | `7eb131c4` | no | blocked | required | stale File Provider + scoped split-row parser; checks remain authoritative |
...
- PR #259 exact head `e1a710a99eb3ee6e0da5478b2b681f1eb5e77717` also pairs a provider operation marker

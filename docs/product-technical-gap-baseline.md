...
**Repository heads at snapshot:** `feat/provider-sync-dynamic-goals` implementation @ `17312fa`; documentation @ `8378a98` (latest incident evidence)

...
**Repository heads at snapshot:** PR #259 `a019dda`, PR #258 `e025680e`, PR #227 `98fa709`, PR #249 `2f1d585`,
PR #247 `0de3f6a`, PR #246 `cbb9dc0`, PR #204 `750213d`, draft PR #198 `cf763cd`, and central `.github` PR #1328 `306de72`;
...
| #258 | `e025680e6f247871df9020608c91631c419a5a7e` | `7eb131c4` | no | blocked | required | current baseline/docs head; checks remain authoritative |
...
| ContextualWisdomLab/.github #1328 | `306de7290f09657dd626a0348af6db7dfb1b0b3c` | `8fd471a3` | no | blocked | required | central autofix protects both normal/conflict deletion paths; all stale Strix/OpenCode gpt-5.4 assertions now match the gpt-5.6-luna fallback contract; 17 focused Python tests plus shell syntax pass, hosted checks re-queued |

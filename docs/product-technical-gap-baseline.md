...
**Repository heads at snapshot:** PR #262 `13f39c5`, PR #260 `041cce6`, PR #259 `ae5e158`, PR #258 `695f0d4`, PR #257 `d09808f`, PR #253 `7db00e2`, PR #251 `7b8caa3`, PR #227 `98fa709`, PR #249 `7c93e17`,
...
| #262 | `13f39c5318d58de1b1720026c7ef05bc525fcbe1` | `7eb131c4` | no | blocked | required | private failure records are isolated from success receipts and capped at 10,000 entries; native cancellation is bound to the active candidate and no longer appears for provider-API uploads; the UI exposes cancellation only for the cancellable native path (frontend contract test added); coverage cfgs now compile successfully under `RUSTFLAGS=--cfg coverage`; production adoption always probes provider-native local-current status before and after final identity checks; failed native-copy cleanup is identity-bound on Unix and Windows, while adoption is explicitly non-cancellable; cancellation feedback is now bounded through the same redaction contract; focused Rust contract tests pass 4/4, unresolved review threads are zero, and current hosted checks and independent approval remain authoritative |
...
| #258 | `695f0d48b32b075e112a5de76895055a9a8e1ac8` | `7eb131c4` | no | blocked | required | current baseline/docs head; records PR #251/#253 dependency evidence and the current timeout, privacy-scope, cancellation, provider-managed traversal, and placeholder-adoption gaps; hosted checks and qualifying approval remain authoritative |

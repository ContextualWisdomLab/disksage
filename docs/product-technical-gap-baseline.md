...
| #258 | `bb1cd4cbe6ce0b3ae5a8065066a3b2f5dfb528ac` | blocked, review required, auto-merge enabled | This baseline and PRD capture the live product gaps, current PR evidence, and the customer-copy contract | Documentation diff check passes; hosted checks and independent approval remain required |

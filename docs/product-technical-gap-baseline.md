...
`7e3c28a47613ae029cb4a0d3bbc24e5ca3f15e35` (later tip commits are documentation-only), with
...
- DiskSage PR #246 functional head is `7e3c28a`; later tip commits are documentation-only, required

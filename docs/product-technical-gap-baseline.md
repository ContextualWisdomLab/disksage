...
- PR #245 exact head `45147d0` adds the ontology-bound orphan cache action and fails closed when
  ...
  pass (6/6, including deep inventory/manifest rejection and object identity replacement rejection).
  Hosted full Rust,

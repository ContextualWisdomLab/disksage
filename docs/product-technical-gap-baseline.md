...
**Repository heads at snapshot:** PR #260 `c4dad65`, PR #259 `86dd521`, PR #258 `cf9de5a`, PR #227 `98fa709`, PR #249 `2f1d585`,
...
| #260 | `c4dad65204956c853d7ca8a3098ac3ccb38c1688` | `7eb131c4` | no | blocked | required | current-main successor for closed draft #225; Rust planner rejects cwd-dependent, named-tilde, and parent-traversal ontology targets, preserves literal absolute tildes, and adds ADR-0010 plus a Windows public-boundary contract; focused organize suite is 22 passed, hosted checks and independent approval remain authoritative |
| #258 | `cf9de5a90e6acacbcb5b6334307f3039d3e26906` | `7eb131c4` | no | blocked | required | current baseline/docs head immediately before this exact-head reconciliation; records PR #260 successor evidence and keeps hosted checks and qualifying approval authoritative |

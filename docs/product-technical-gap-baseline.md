...
| #246 | `df3c231d811caf848cea758690226f2542f7dc17` | blocked, review required, auto-merge enabled | Customer guidance now hides implementation terms in iCloud feedback, copy records, and page metadata; the executable contract rejects forbidden vocabulary and requires next actions | Full UI suite 173/173, Svelte check 0 errors/0 warnings, and diff check pass; hosted checks and independent approval remain required |

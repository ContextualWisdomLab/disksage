...
`9d7fbb41586abdd94032ac4e5475a78a3cf23389`, with the deleted URL/loopback tests and doctoring
document restored after a seventh optimizer regression, explicit zero ports rejected in both

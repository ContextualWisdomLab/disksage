...
| P1 | Open PR queue prevents a clean protected release line. | At this loop capture PR #213 is exact head `4b8c0b2` on `feat/provider-sync-dynamic-goals`; its required checks are running/queued and the prior review decision remains stale `CHANGES_REQUESTED`, with no unresolved current thread. PR #189 is at `635d918`, PR #209 at `0fc67a4`, PR #228 at `1eb947e`, PR #179 at `9ef9b1b`, and Naruon PR #1434 at `c0848017`; all remain unmerged pending exact-head checks/review. | Process one PR at a time: current-head review → fix → required checks → fresh approval → normal protected merge; never bypass or self-approve. |

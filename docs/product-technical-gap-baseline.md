...
`58db694f0c01333115024045190fba0453534564` (later tip commits are documentation-only), with
...
- DiskSage PR #246 functional head is `58db694`; later tip commits are documentation-only, required

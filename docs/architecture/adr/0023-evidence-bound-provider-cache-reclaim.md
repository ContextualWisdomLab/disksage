...
#303 adopts the current #344 private-publication owner exact `457515961fa1abaabc768061ce78d38c47dba911` through non-force second-parent ancestry at `84d6a1342eb275c96e0756f6e81afb2af5418168`. The inherited owner source/test blobs remain canonical; provider-cache does not maintain a copied private-directory implementation.
...
- `abbf1d2fe7758bfb6d51f23ea87a3c8c165fe5da` / `457515961fa1abaabc768061ce78d38c47dba911`: #344 real-filesystem existing-final-parent mode-drift RED and production repair; #303 adoption `84d6a1342eb275c96e0756f6e81afb2af5418168` inherits the exact owner blobs non-force.
...
Final success now requires the admitted record identity, exact record mode, and exact final-parent private mode to survive the final race window. This closes the discovered same-UID permission-widening holes without moving filesystem implementation into the provider-cache bounded context.

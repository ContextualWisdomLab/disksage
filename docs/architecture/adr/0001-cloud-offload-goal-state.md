...
The current orphan implementation head `3d2406c` (with subsequent documentation-only commits) also treats an incomplete installed-application inventory or

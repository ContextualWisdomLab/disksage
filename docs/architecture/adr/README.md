...
| [0023](0023-evidence-bound-provider-cache-reclaim.md) | Evidence-bound provider cache reclaim | Proposed |

ADR-0012 through ADR-0022 are allocated by earlier active owner lineages and are intentionally not

...
| [0024](0024-colima-disk-reclaim-native-boundary.md) | Keep Colima disk reclaim behind supported provider boundaries | Proposed |

ADR-0012 through ADR-0023 are allocated by earlier active owner lineages and are intentionally not

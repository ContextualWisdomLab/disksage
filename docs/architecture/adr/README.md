...
| [0020](0020-podman-native-storage-repair.md) | Use fingerprint-bound native Podman storage repair without force | Accepted |
| [0021](0021-opencode-tool-output-reference-lineage.md) | Preserve OpenCode history and reclaim only unreferenced tool outputs | Accepted |

...
describe("api wrappers", () => {
  ...
  it("forwards every command to Tauri with the expected payload shape", () => {
    ...
    const cases: Array<[() => unknown, string, unknown?]> = [
      ...
      [() => api.auditExactPhotoDuplicates(["/repo/a.png"], 7), "audit_exact_photo_duplicates", { paths: ["/repo/a.png"], generatedAtMs: 7 }],
      [() => api.planExactPhotoDuplicateQuarantine("/repo", {} as api.PhotoDuplicateAudit, []), "plan_exact_photo_duplicate_quarantine", { sourceRoot: "/repo", audit: {}, selections: [] }],
      [() => api.executeExactPhotoDuplicateQuarantine("/repo", {} as api.PhotoDuplicateAudit, {} as api.PhotoQuarantinePlan, "typed", "reviewed", 9), "execute_exact_photo_duplicate_quarantine", { sourceRoot: "/repo", audit: {}, plan: {}, approvalPhrase: "typed", rationale: "reviewed", executedAtMs: 9 }],

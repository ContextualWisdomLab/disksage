...
export function podmanEvidenceMetrics(plan: PodmanReclaimPlan): PodmanEvidenceMetric[] {
  return [
    {
      key: "configured_disk_bytes",
      label: "VM 설정 디스크 용량",
      bytes: plan.machine?.configured_disk_bytes ?? null,
      evidence_class: "configured",
    },
    {
      key: "raw_logical_bytes",
      label: "raw 이미지 논리 크기",
      bytes: plan.raw_image?.logical_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "raw_allocated_bytes",
      label: "raw 이미지 호스트 할당",
      bytes: plan.raw_image?.allocated_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "guest_total_bytes",
      label: "게스트 파일시스템 전체",
      bytes: plan.guest_filesystem?.total_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "guest_used_bytes",
      label: "게스트 파일시스템 사용",
      bytes: plan.guest_filesystem?.used_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "guest_available_bytes",
      label: "게스트 파일시스템 여유",
      bytes: plan.guest_filesystem?.available_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "graph_root_allocated_bytes",
      label: "Podman graph root 할당",
      bytes: plan.store?.graph_root_allocated_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "graph_root_used_bytes",
      label: "Podman graph root 사용",
      bytes: plan.store?.graph_root_used_bytes ?? null,
      evidence_class: "observed",
    },
    {
      key: "image_candidate_bytes",
      label: "이미지 논리 후보",
      bytes: plan.system_df?.images.reclaimable_bytes ?? null,
      evidence_class: "logical_candidate",
    },
    {
      key: "stopped_container_candidate_bytes",
      label: "중지 컨테이너 논리 후보",
      bytes: plan.system_df?.containers.reclaimable_bytes ?? null,
      evidence_class: "logical_candidate",
    },
    {
      key: "volume_candidate_bytes",
      label: "볼륨 논리 후보",
      bytes: plan.system_df?.local_volumes.reclaimable_bytes ?? null,
      evidence_class: "logical_candidate",
    },
    {
      key: "physically_reclaimable_bytes",
      label: "호스트 물리 회수량",
      bytes: plan.assessment.physically_reclaimable_bytes,

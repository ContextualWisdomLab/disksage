...
function plan(overrides: Partial<PodmanReclaimPlan> = {}): PodmanReclaimPlan {
  return {
    ...
    elapsed_ms: 250,
    machine: {
      name: "sensitive-machine-name",
      state: "running",
      configured_disk_bytes: 1000,
    },
    raw_image: {
      path: "/Users/alice/.local/share/containers/podman-machine.raw",
      logical_bytes: 900,
      allocated_bytes: 700,
    },
    guest_filesystem: {
      ...
      recommended_actions: [
        {
          ...
          rationale: "이미지와 볼륨은 서로 다른 승인으로 검토합니다.",
        },
      ],
    },

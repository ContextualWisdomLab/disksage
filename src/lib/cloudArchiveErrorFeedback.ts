...
const CLOUD_ARCHIVE_ERROR_MESSAGES: Record<CloudArchiveErrorOperation, string> = {
  initialize: "클라우드 상태를 불러오지 못했습니다. 새로고침한 뒤 다시 시도하십시오.",
  preview: "클라우드 오프로드 계획을 만들지 못했습니다. 조건과 연결 상태를 확인한 뒤 다시 시도하십시오.",
  review: "클라우드 후보 검토 결정을 저장하지 못했습니다. 목록을 확인한 뒤 다시 시도하십시오.",
  copy: "클라우드 복사를 실행하지 못했습니다. 상태를 확인한 뒤 다시 시도하십시오.",
  cancel: "진행 중인 클라우드 복사를 취소하지 못했습니다. 진행 상태를 다시 확인하십시오.",
  "provider-api-copy": "연결된 클라우드 서비스로 업로드하지 못했습니다. 연결 상태와 저장 공간을 확인한 뒤 다시 시도하십시오.",
  adopt: "기존 클라우드 복사본을 확인하지 못했습니다. 클라우드 상태를 다시 확인한 뒤 다시 시도하십시오.",
  attest: "클라우드 복사본의 업로드 상태를 확인하지 못했습니다. 잠시 후 다시 확인하십시오.",
  reconcile: "기존 클라우드 영수증을 재검증하지 못했습니다. 상태를 다시 확인하십시오.",
  "icloud-health": "iCloud 동기화 상태를 확인하지 못했습니다. 잠시 후 다시 확인하십시오.",
  "finder-copy-cancel": "Finder 복사 취소 요청을 완료하지 못했습니다. 복사 상태를 다시 확인하십시오.",
  "provider-sync": "클라우드 동기화 상태를 확인하지 못했습니다. 잠시 후 다시 확인하십시오.",
  "provider-recovery": "클라우드 앱을 다시 준비하지 못했습니다. 앱 상태를 확인한 뒤 다시 시도하십시오.",
  evict: "검증된 로컬 원본을 휴지통으로 이동하지 못했습니다. 상태를 다시 확인하십시오.",
  capacity: "클라우드 계정 용량을 확인하지 못했습니다. 연결과 저장 공간을 확인한 뒤 다시 시도하십시오.",
  connect: "클라우드 연결을 완료하지 못했습니다. 연결 정보를 확인한 뒤 다시 시도하십시오.",

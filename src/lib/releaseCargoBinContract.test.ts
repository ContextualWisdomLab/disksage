...
/** Collect every Cargo feature that gates an explicitly declared binary target. */
...
/** Extract the comma-delimited Cargo feature set passed to the Tauri release build. */
